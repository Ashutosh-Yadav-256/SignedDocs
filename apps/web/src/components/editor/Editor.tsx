...
import { Clock, ShieldCheck, Sparkles, BookOpen, User } from 'lucide-react';
...
export const Editor: React.FC<EditorProps> = ({
  ...
  return (
    <div className="flex flex-col bg-cream-50 border border-cream-border rounded-xl overflow-hidden shadow-none">
      {/* Formatting Toolbar */}
      <EditorToolbar editor={editor} onFlushCommit={onFlushCommit} />

      {/* Medium-Style Long-Form Publication Canvas */}
      <div className="flex-1 overflow-y-auto px-6 sm:px-12 md:px-16 py-8 max-w-3xl w-full mx-auto">
        ...
        <div className="border-b border-cream-border pb-6 mb-8 font-sans">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 pt-1">
            <div className="flex items-center space-x-3">
              ...
              <div className="space-y-0.5">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-xs text-sage-dark flex items-center gap-1 bg-sage-light px-1.5 py-0.2 rounded border border-sage-border font-medium">
            ...
            <div className="flex items-center space-x-2 text-xs text-charcoal-muted font-mono bg-cream-subtle px-2.5 py-1 rounded border border-cream-border">
